...
/****** Object:  Database [mapdb]    Script Date: 11/27/2023 7:33:22 AM ******/
CREATE DATABASE [mapdb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'mapdb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\mapdb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'mapdb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\mapdb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [mapdb] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [mapdb] SET RECOVERY FULL 
GO
...
ALTER DATABASE [mapdb] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [mapdb] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [mapdb] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [mapdb] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [mapdb] SET QUERY_STORE = ON
GO

ALTER DATABASE [mapdb] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
